...
public enum ErrorCode {
    ...
    REFRESH_TOKEN_EXPIRED(HttpStatus.UNAUTHORIZED, "AUTH_008", "Refresh token is invalid or expired"),
    INVALIDE_GOOGLE_TOKEN(HttpStatus.UNAUTHORIZED, "AUTH_009", "Invalid Google token");
